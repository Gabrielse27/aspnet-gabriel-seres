...
namespace CoreFitness.Infrastructure.Migrations
{
    ...
    [Migration("20260415083933_AddedDetailsToGymSession")]
    partial class AddedDetailsToGymSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreFitness.Domain.Entities.ContactRequestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreFitness.Domain.Entities.GymSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreFitness.Domain.Identity.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CoreFitness.Domain.Entities.GymSession", b =>
                {
                    b.HasOne("CoreFitness.Domain.Identity.User", "BookedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreFitness.Domain.Entities.MemberEntity", b =>
                {
                    b.HasOne("CoreFitness.Domain.Identity.User", null)
                        .WithOne("Member")
                        .HasForeignKey("CoreFitness.Domain.Entities.MemberEntity", "UserId")
